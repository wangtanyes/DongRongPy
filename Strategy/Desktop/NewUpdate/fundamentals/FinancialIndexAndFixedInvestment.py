...
class FinancialIndexAndFixedInvestment():
    """行业固定投资和财务指标"""
    ...
    def start(self,fritime):
        ...
        self.getNum("financialIndex_fixedInvestment","financialIndex_fixedInvestment_num",fritime,fritime) #导入昨天的数据
...
if __name__ == "__main__":
    ...
    sched.add_job(FinancialIndexAndFixedInvestment().start, "cron", month="*", day='10', hour="23", minute="00")
    sched.start()